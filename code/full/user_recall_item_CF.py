# -*- coding: utf-8 -*-
"""
Created on Thu Oct 10 15:37:56 2019
利用item-CF进行用户召回
@author: tqd95
"""
...
def get_user_watched_item(train):
    ...
    user_stats = pd.read_csv(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\users_cleaned.csv')
...
# 对测试集用户，生成召回表
def get_test_recall(user_item, user_watched_item, W, K1=10, K2=20):
    '''
    @test: 不加任何加工的测试集;
...
with open(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\full\similarity_maxtrix_top300.json', 'r', encoding='UTF-8') as f:
    W = json.load(f)
...
## 开始召回
start = time.time()
print('begin item-cf recall...')
test_recall = get_test_recall(user_item=user_item,user_watched_item=user_watched_item, 
                              W=W, K1=10, K2=20)
end = time.time()
print('item-cf recall completed...')
print('time used:', (end-start)/60, 'minutes')  # 42 minutes!!!
...
test_recall.to_pickle(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\full\test_recall.pkl')
