# -*- coding: utf-8 -*-
"""
Created on Tue Oct 29 08:49:05 2019
求老番与新番间的cosine距离
@author: tqd95
"""
...
feature_item.to_pickle(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\imputation\knn\feature_item.pkl')
...
with open(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\imputation\knn\old_new_cosine_dist_maxtrix.json','w') as outfile:
    json.dump(W, outfile)
