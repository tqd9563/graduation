# -*- coding: utf-8 -*-
"""
Created on Tue Oct 29 09:07:37 2019
对KNN填充后的数据作related召回
@author: tqd95
"""
...
def get_user_item_ranking(train):
    ...
    res = train.loc[train.label == 1, ['user_id', 'anime_id', 'my_score']] \
                ...
                .reset_index() \
                .drop('level_1', axis=1)
    res.to_pickle(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\imputation\knn\user_item_ranking.pkl')        
    return res
...
def get_user_watched_item(train):
    ...
    res.to_pickle(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\imputation\knn\user_watched_item.pkl')
    return res
...
user_item_ranking = pd.read_pickle(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\imputation\knn\user_item_ranking.pkl')
user_watched_item = pd.read_pickle(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\imputation\knn\user_watched_item.pkl')
...
test_related_recall.to_pickle(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\imputation\knn\test_related_recall_10.pkl')
