# -*- coding: utf-8 -*-
"""
Created on Sat Sep 21 08:20:05 2019
求老番与新番间的cosine距离
@author: tqd95
"""
...
item_feature_count, item_co_count = get_count_matrix(feature_item)  # 用时20.4s
...
with open(r'C:\Users\tqd95\Desktop\graduation_thesis\dataset\sampling\old_new_cosine_dist_maxtrix.json','w') as outfile:
    json.dump(W, outfile)
